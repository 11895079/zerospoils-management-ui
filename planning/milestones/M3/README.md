...
| **199** | Canada seed barcode catalog curation | 🔄 In Progress | — | Curation pipeline + tests + initial seed artifact/report + governance doc are added; runtime catalog ingestion wiring remains |
