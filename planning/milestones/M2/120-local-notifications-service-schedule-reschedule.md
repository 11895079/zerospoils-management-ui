...
## Test plan
**Automated:**
- Unit: schedule time calculation based on expiry date and bucket thresholds (see notification_service_test.dart)
...
11. All tests and analysis pass in CI (Jan 28, 2026)
